...
export const HomePage = ({ newPresentation, viewPresentations }) => {
    const iconStyles = {
        largeIcon: {
            width: 80,
            height: 65,
            ...
            <div className="flex md:flex-row flex-wrap h-full">
                ...
                <div className="w-full md:w-1/4 bg-white p-4 text-left text-gray-700 pt-10">
                    ...
                    <div className="pt-4 items-center">
                        <button onClick={viewPresentations} className="bg-blue-500 hover:bg-blue-700 text-white font-bold py-1 px-4 rounded "  >
                            View presentations
                        </button>
                    </div>
                </div>
