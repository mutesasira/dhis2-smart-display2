  ...
  return (
    <div className="flex md:flex-row flex-wrap h-64 ml-6 py-2 px-4">
      ...
      <div className="flex flex-col w-full md:w-1/2 pr-6 mb-10">
        ...
        <TextArea value={currentPresentation.description} placeholder="Presentation description" onChange={currentPresentation.onDescriptionChange} className="w-full pl-12" rows={3} />
      </div>
      <div className="flex flex-col w-full md:w-1/2 pl-6 mb-10 ">
